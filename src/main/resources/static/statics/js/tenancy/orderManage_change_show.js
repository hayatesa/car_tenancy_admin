...
function getdate() {
    ...
    if(orderchange_data.order.gmtModified!=null) orderchange_data.order.gmtModified = orderchange_data.order.gmtModified.substr(0,orderchange_data.order.gmtModified.length-3)
}